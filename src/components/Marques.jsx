...
function Marques() {
  ...
  return (
    <div className='mt-32 py-20 w-full relative overflow-hidden max-lg:mt-[10vh] max-lg:py-[5vh] max-lg:w-[100vw]'>
        {images.map((item, idx) => <Marque key={idx} direction = {idx === 0 ? "left" : "right"} imagurl = {item} />)}
